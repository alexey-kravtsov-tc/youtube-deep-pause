...
* **Google Gemini API:** Utilizes the Gemini 3.1 Flash Lite model for rapid transcript synthesis.
* **YouTube Data API (v3):** Infrastructure is prepared for deeper YouTube metadata integration.
...
3.  **Configure:** Click the ⚙ icon in the widget to open the settings menu. You will need:
    ...
    * **YouTube Data API (v3) Key:** For metadata retrieval (Available via Google Cloud Console).
